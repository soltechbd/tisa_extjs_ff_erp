function item_submit_form() {
    ...
    /* ItemITEM_SUBMIT_FORM Type part end */
...
function Submit_Item() {
    ...
    if (Ext.getCmp('itemTypeName').getRawValue().match(Ext.getCmp('itemTypeName').getValue())) {
        ...
        SUB_ITEM.itemTypes.new_itemType_found = true; /* if found new data then it's true  */

    } else {

        SUB_ITEM.itemTypes.new_itemType_found = false; /* if not found new data then it's false  */
    }
