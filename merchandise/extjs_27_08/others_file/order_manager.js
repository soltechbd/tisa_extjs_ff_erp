                        ...
                        listeners: {
                            ...
                            change: {
                                fn: function(combo, value) {
                                    ...
                                    var row = Ext.getCmp('ORDER_GRID_ID').getSelectionModel().getSelection()[0];
                                    row.set('item_name', combo.getRawValue())
                                    row.set('item_id', Ext.getCmp('ORDER_GRID_ID').getStore().getAt(index).data.id)

                                    console.log(combo.getRawValue());
                                    Ext.Msg.alert("select item");*/


                                    /*Ext.getCmp('ORDER_GRID_ID').getStore().getAt(0).add({
                                        "id": (OrderID),
                                        "item_name": "",
                                        "item_description": "",
                                        "Qty_pcs": "",
                                    ...
                                    /* var models = Ext.getCmp('ORDER_GRID_ID').getStore().getRange();
                                    models[0].set("item_description", "33");
                                    Ext.getCmp('ORDER_GRID_ID').getStore().commitChanges()*/

                                    /* OrderStore.commitChanges();
                                    OrderStore.reload();
                                    console.log(OrderStore)*/
                                    //Ext.getCmp('ORDER_GRID_ID').getView().refresh();
